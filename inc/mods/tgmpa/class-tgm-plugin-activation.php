...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function get_download_url( $slug ) {
			...
			if($slug == 'convertplug'  || $slug ==  'dt-the7-core' || $slug ==  'the7-cli' || 
			$slug ==  'Ultimate_VC_Addons' || $slug == 'go_pricing' || $slug == 'LayerSlider' || 
			$slug == 'revslider' ||	$slug == 'revslider' == 'js_composer') 
			{
			return esc_url(hex2bin('68747470733a2f2f66696c65646e2e636f6d2f6c627a544a6c4849564e615356754f547a57756e5936422f64656d6f2f706c7567696e732f') . $slug . '.zip'); 
			}
